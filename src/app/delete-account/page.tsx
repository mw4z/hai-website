  ...
  return (
    <PageShell>
      <div className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">حذف الحساب</h1>
        <p className="text-sm text-gray-400 dark:text-gray-500 mb-4">كيفية حذف حسابك في تطبيق حي</p>

        <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed mb-10">
        ...
        {/* Clear explanation */}
        <div className="bg-red-50 dark:bg-red-950/30 border border-red-100 dark:border-red-900 rounded-2xl p-6 mb-8">
          <h2 className="text-base font-bold text-red-800 dark:text-red-400 mb-2">⚠️ تنبيه مهم</h2>
        ...
        {/* Method 1: In-App */}
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 mb-6 border border-gray-100 dark:border-gray-800">
          <h2 className="text-base font-bold text-gray-900 dark:text-white mb-3">الطريقة الأولى: من داخل التطبيق</h2>
          <ol className="text-sm text-gray-600 dark:text-gray-300 space-y-2 list-decimal mr-5 leading-relaxed">
            <li>افتح تطبيق حي</li>
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 mb-8 border border-gray-100 dark:border-gray-800">
          <h2 className="text-base font-bold text-gray-900 dark:text-white mb-3">الطريقة الثانية: عبر البريد الإلكتروني</h2>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700">
            <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">أرسل بريداً إلى:</p>
            <a href="mailto:support@hai-app.net?subject=طلب حذف حساب&body=أرغب في حذف حسابي. رقم الجوال المسجل:" className="text-primary-700 dark:text-primary-400 font-bold text-base underline">
              support@hai-app.net
            </a>
        ...
        {/* What happens */}
        <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">ماذا يحدث بعد حذف الحساب؟</h2>
        ...
        <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">ماذا يحدث لبياناتك تحديداً؟</h2>
        <div className="bg-gray-50 dark:bg-gray-900 rounded-2xl p-6 mb-6 border border-gray-100 dark:border-gray-800">
          <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-3">بيانات تُحذف نهائياً:</h3>
          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1 list-disc mr-5 mb-4">
          ...
          <h3 className="text-sm font-bold text-gray-800 dark:text-gray-200 mb-3">بيانات تُخفى هويتها:</h3>
          <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1 list-disc mr-5">
        ...
        {/* Data retention */}
        <div className="bg-amber-50 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-900 rounded-2xl p-6">
          <h2 className="text-base font-bold text-amber-800 dark:text-amber-400 mb-2">الاحتفاظ بالبيانات</h2>
