  ...
  return (
    <PageShell>
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-gray-400 mb-10">كيفية حذف حسابك في تطبيق حي</p>
        ...
        <div className="bg-red-50 border border-red-100 rounded-2xl p-6 mb-8">
          ...
          <p className="text-sm text-red-700 leading-relaxed">
            حذف الحساب إجراء نهائي ولا يمكن التراجع عنه. سيتم حذف بياناتك الشخصية وإخفاء هوية محتواك المنشور سابقاً.
          </p>
        </div>
        ...
        <div className="bg-gray-50 rounded-2xl p-6 mb-8 border border-gray-100">
          ...
          <p className="text-sm text-gray-600 leading-relaxed mb-3">
            إذا لم تستطع الوصول إلى التطبيق أو تم إلغاء تثبيته، يمكنك طلب حذف حسابك عبر البريد الإلكتروني:
          </p>
        ...
        <div className="bg-amber-50 border border-amber-100 rounded-2xl p-6">
          ...
          <p className="text-sm text-amber-700 leading-relaxed">
            قد نحتفظ ببعض السجلات المجهولة الهوية لأغراض أمنية أو قانونية لفترة محدودة وفقاً للأنظمة المعمول بها في المملكة العربية السعودية. لا تتضمن هذه السجلات أي معلومات شخصية قابلة للتعريف.
          </p>
        </div>
      </div>
    </PageShell>
