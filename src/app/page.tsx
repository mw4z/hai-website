        ...
        <div className="max-w-3xl mx-auto px-6 text-center animate-on-scroll">
          <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-3xl p-10 md:p-14 shadow-2xl shadow-primary-600/20">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              {/* Official store badges (Apple's own SVG — vector, crisp at
                  any DPI; Google's official Arabic PNG). Heights are matched
                  by visible pill: Google's badge has built-in padding, so
                  it's set a touch taller than Apple's. */}
              <a
              ...
              >
                ...
                <img src="/badges/app-store.svg" alt="Download on the App Store" className="h-[52px] w-auto" />
              </a>
              <a
              ...
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/badges/google-play-ar.png" alt="احصل عليه من Google Play" className="h-[60px] w-auto" />
              </a>
            </div>
          </div>
        </div>
