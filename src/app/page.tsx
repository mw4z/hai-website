      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center animate-on-scroll">
          <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-3xl p-10 md:p-14 shadow-2xl shadow-primary-600/20">
            ...
            {/* Matched store-badge pair — identical WHITE pills (same height,
                padding, radius, shadow) that pop on the green card, with the
                black Apple glyph + colorful Google Play glyph. One shared
                style so they always line up. dir="ltr" keeps icon-then-
                wordmark order on the RTL page. */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3" dir="ltr">
              ...
              >
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-[9px] font-medium text-gray-500 uppercase tracking-wider">Download on the</span>
              ...
              >
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-[9px] font-medium text-gray-500 uppercase tracking-wider">Get it on</span>
