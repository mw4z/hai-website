      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-6 text-center animate-on-scroll">
          <div className="bg-gradient-to-br from-primary-600 to-primary-800 rounded-3xl p-10 md:p-14 shadow-2xl shadow-primary-600/20">
            ...
            {/* Matched store-badge pair: identical black pills (same height,
                padding, radius) with the official Apple glyph + colorful
                Google Play glyph. Built as one consistent style so the two
                always line up — no asset size/color mismatch. dir="ltr" keeps
                the icon-then-wordmark order on the RTL page. */}
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3" dir="ltr">
              <a
                href="https://apps.apple.com/us/app/%D8%AD%D9%8A/id6761731680"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Download Hai on the App Store"
                className="inline-flex items-center gap-2.5 h-[58px] px-5 rounded-xl bg-black text-white border border-white/10 hover:bg-zinc-800 transition-colors"
              >
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-[10px] font-medium opacity-90">حمّل من</span>
              ...
              >
                ...
                <span className="flex flex-col items-start leading-tight">
                  <span className="text-[10px] font-medium opacity-90">احصل عليه من</span>
                  <span className="text-[18px] font-semibold -mt-0.5">Google Play</span>
                </span>
              </a>
            </div>
          </div>
...
const FEATURES = [
  ...
  { icon: '🔧', title: 'خدمات موثوقة', desc: 'ابحث عن اللي يساعدك — سباك، كهربائي، نجّار، حلاق.' },
  { icon: '🎉', title: 'فعاليات ومناسبات', desc: 'تجمّعات الحي، الأعراس والعزاءات، وكل ما يخصّ جيرانك.' },
  { icon: '🚗', title: 'مشاوير وتوصيل', desc: 'اطلب مشوار أو توصيل من جارك — قارن العروض وتتبّع طلبك خطوة بخطوة.' },
